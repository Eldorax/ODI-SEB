...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'check_connection' => 'getCheckConnectionService',
            ...
            'response_event' => 'getResponseEventService',
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('PrtU9iRS5C', '', (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vqblGxOc-0', '', 'mTiVA9egdP6EX8lY7iUF9A', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('E4c165Kr8G', '', 'mTiVA9egdP6EX8lY7iUF9A', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Wta2IOc98Y', '', 'mTiVA9egdP6EX8lY7iUF9A', (__DIR__.'/pools'), $a));
    ...
    /**
     * Gets the 'check_connection' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\services\CheckConnection A AppBundle\services\CheckConnection instance
     */
    protected function getCheckConnectionService()
    {
        return $this->services['check_connection'] = new \AppBundle\services\CheckConnection($this->get('session'));
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('kernel.response', array(0 => 'response_event', 1 => 'onKernelResponse'), 0);
        ...
        $instance->addSubscriberService('request.add_request_formats_listener', 'Symfony\\Component\\HttpKernel\\EventListener\\AddRequestFormatsListener');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'projet', 'user' => 'root', 'password' => 'jdev', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_98a909b118a54ba48319a9f0b3b85563d46058891a0061f8a2a58e310dbb8b80');
    ...
    {
        return $this->services['request.add_request_formats_listener'] = new \Symfony\Component\HttpKernel\EventListener\AddRequestFormatsListener(array('csv' => array(0 => 'text/csv')));
    }
    ...
    /**
     * Gets the 'response_event' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\services\GetResponseEvent A AppBundle\services\GetResponseEvent instance
     */
    protected function getResponseEventService()
    {
        return $this->services['response_event'] = new \AppBundle\services\GetResponseEvent('%event');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('36240455832fff9946d005b1243528f32dbceb27');
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addYamlMappings(array(0 => ($this->targetDirs[3].'/src/AppBundle/Resources/config/validation/Produit.orm.yml')));
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('585d589206bf23.03411833')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_user' => 'root',
            'database_password' => 'jdev',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => '36240455832fff9946d005b1243528f32dbceb27',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '36240455832fff9946d005b1243528f32dbceb27',
